<x-layout>
    ...
    <div class="d-flex flex-column flex-lg-row align-items-stretch justify-content-between gap-1 mb-1 bios-box-wrapper">
        <div class="p-5 bios-box">
            ...
            <p>Over the years I've been lucky enough to work on projects for companies such as Dyson, BBC, Marvel, Disney, Cartoon Network, the Welsh Government, and the National Oceanography Centre, to name a few.</p>
            <p>This blog is where I share things I've learned, problems I've solved, and the occasional experiment that didn't go to plan.</p>
