...
<head>
    ...
    <link href="https://db.onlinewebfonts.com/a/vhZ7N1MV" rel="stylesheet" type="text/css"/>
...
<main class="container">
    <div class="w-100 bios-box">
        ...
        <footer class="d-flex align-items-center justify-content-start gap-4 w-100 p-5 bios-box">
